...
const getAudio = async (req, res) => {
    try {
        ...
        if (!ytId) return res.status(400).json({error: "please provide a valid parameter!"});
        ...
        res.json({ thumbnail, title, quality, type, size, link });
    } catch (e) {
        console.log(e)
    }
}
...
module.exports = { search, getAudio, getVideo }
